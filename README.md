...
V1.67 .. June,28 2021 ... first version which officially runs on Rapberry PI-3B+ without problems (choose smaller screen size i.e. 1024x768, and disable beacon lock (important !) the lock symbol must show "FREE"). Also works on Orange PC+. 
